                ...
                <div class="row g-3">
                    ...
                    <div class="col-auto">
                        <input type="text" class="form-control form-control-sm"
                            wire:model.live.debounce.500ms="cariRuangan" placeholder="Cari Ruangan" id="cariRuangan">
                    </div>
                    <div class="col-auto">
                ...
                <form wire:submit="simpan">
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="mb-3">
                                <label for="modalLokasi" class="form-label">Lokasi</label>
                                <input type="text" class="form-control" id="modalLokasi" wire:model="lokasi">
                                @error('lokasi')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                {{-- <input type="text" class="form-control" id="modalKeterangan" wire:model="keterangan"> --}}
                                <textarea class="form-control" id="modalKeterangan" cols="30" rows="10" wire:model='keterangan'></textarea>
                                @error('keterangan')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
    ...
    @push('scripts')
        <script>
            window.addEventListener('resetCariFields', () => {
                document.getElementById('cariRuangan').value = '';
            });
        </script>
